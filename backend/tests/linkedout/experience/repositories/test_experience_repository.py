...
"""Wiring tests for ExperienceRepository."""
import pytest
...
class TestExperienceRepositoryWiring:
    def test_can_instantiate(self):
        repo = ExperienceRepository(Mock(spec=Session))
...
class TestExperienceRepositoryIntegration:
    ...
    def crawled_profile(self, db_session):
        ...
        profile = CrawledProfileEntity(
            linkedin_url='https://linkedin.com/in/test-exp-profile',
            data_source='test',
        )
    ...
    def repository(self, db_session):
        return ExperienceRepository(db_session)
