...
"""Wiring tests for EducationRepository."""
import pytest
...
class TestEducationRepositoryWiring:
    def test_can_instantiate(self):
        repo = EducationRepository(Mock(spec=Session))
...
class TestEducationRepositoryIntegration:
    ...
    def crawled_profile(self, db_session):
        ...
        profile = CrawledProfileEntity(
            linkedin_url='https://linkedin.com/in/test-edu-profile',
            data_source='test',
        )
    ...
    def test_create_generates_id_with_prefix(self, repository, db_session, crawled_profile):
        ...
        assert created.id.startswith('edu_')
