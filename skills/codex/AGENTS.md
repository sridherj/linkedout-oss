...
Skills are located in `.agents/skills/`. Each skill has a `SKILL.md` with full instructions.
...
**Skill path:** `.agents/skills/linkedout/SKILL.md`
...
**Skill path:** `.agents/skills/linkedout-setup/SKILL.md`
...
**Skill path:** `.agents/skills/linkedout-upgrade/SKILL.md`
...
**Skill path:** `.agents/skills/linkedout-history/SKILL.md`
...
**Skill path:** `.agents/skills/linkedout-report/SKILL.md`
...
**Skill path:** `.agents/skills/linkedout-extension-setup/SKILL.md`
...
**Skill path:** `.agents/skills/linkedout-enrich/SKILL.md`
...
**Skill path:** `.agents/skills/linkedout-setup-report/SKILL.md`
