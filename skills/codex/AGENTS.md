...
Skills are located in `.agents/skills/linkedout/`. Each skill has a `SKILL.md` with full instructions.
...
**Skill path:** `.agents/skills/linkedout/linkedout/SKILL.md`
...
**Skill path:** `.agents/skills/linkedout/linkedout-setup/SKILL.md`
...
**Skill path:** `.agents/skills/linkedout/linkedout-upgrade/SKILL.md`
...
**Skill path:** `.agents/skills/linkedout/linkedout-history/SKILL.md`
...
**Skill path:** `.agents/skills/linkedout/linkedout-report/SKILL.md`
...
**Skill path:** `.agents/skills/linkedout/linkedout-extension-setup/SKILL.md`
...
**Skill path:** `.agents/skills/linkedout/linkedout-setup-report/SKILL.md`
