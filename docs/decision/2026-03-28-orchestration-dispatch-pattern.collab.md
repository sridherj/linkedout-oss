...
- The 4 issues are documented in <prior-project>/orchestration_issue.md for future API fixes

## References
- <prior-project>/orchestration_issue.md (detailed issue writeup with evidence)
- <prior-project>/taskos/goals/linkedin-ai-production/ (goal directory)
