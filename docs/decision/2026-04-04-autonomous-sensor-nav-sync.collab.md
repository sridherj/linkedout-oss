...
## References
- `<linkedout-fe>/extension/src/voyager.content.ts`
- `<linkedout-fe>/extension/src/background.ts`
- `<linkedout-fe>/extension/src/messages.ts`
- `<linkedout-fe>/extension/src/App.tsx`
- `<linkedout-fe>/extension/src/bridge.content.ts`
