...
- Plan: `~/workspace/second-brain/taskos/goals/linkedout-chrome-plugin/plan_post_spike.collab.md` (Phase 2a, Phase 4a)
- Spec: `/data/workspace/linkedout/docs/specs/chrome_extension.collab.md`
